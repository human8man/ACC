...
CCamera::CCamera()
	...
	, m_NowCurorPos		{ WND_WM, WND_HM }
	, m_BeforCursorPos	{ WND_WM, WND_HM }
	, m_MoveValue		( 0.1f )
	, m_CameraYaw		( 0.f )
	, m_CameraPitch		( 0.f )
...
{
	SetCursorPos	   ( WND_WM, WND_HM ); // 現在のマウス位置をリセット.
	m_BeforCursorPos = { WND_WM, WND_HM }; // 過去のマウス位置をリセット.
}