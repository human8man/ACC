...
{
	float w = m_SpriteState.Disp.w / 2.f; // 中心を基準に作るので半分にする
	float h = m_SpriteState.Disp.h / 2.f; // 中心を基準に作るので半分にする
	...
	{
		// 頂点座標(x,y,z)、UV座標(u,v)
		D3DXVECTOR3(-w,-h, 0.f ), D3DXVECTOR2( .0f,   v ),	// 頂点１(左下)
		D3DXVECTOR3(-w, h, 0.f ), D3DXVECTOR2( .0f, 0.f ),	// 頂点２(左上)
		D3DXVECTOR3( w,-h, 0.f ), D3DXVECTOR2(   u,   v ),	// 頂点３(右下)
		D3DXVECTOR3( w, h, 0.f ), D3DXVECTOR2(   u, 0.f )	// 頂点４(右上)
	};
	// 最大要素数を算出する
...
//		レンダリング用
//=============================================================================
void Sprite3D::Render( D3DXMATRIX& mView,D3DXMATRIX& mProj )
{
...
//		スプライト情報の読込
//=============================================================================
HRESULT Sprite3D::SpriteStateDataLoad(const std::string& FilePath)
{
...
//=============================================================================
HRESULT Sprite3D::CreateSpriteState(const std::string& FilePath)
{
	// 作成するファイルパス
	std::string TextPath = FilePath;
	TextPath.erase(TextPath.find("."), TextPath.size()) += ".json";
