...
//		描画処理
//============================================================================
void StaticMeshObject::Draw( D3DXMATRIX& View, D3DXMATRIX& Proj, LIGHT& Light )
{
	if( m_pMesh == nullptr ){ return; }
...
//		レイとメッシュの当たり判定
//============================================================================
RayInfo StaticMeshObject::IsHitForRay(const RAY& pRay )
{
	FLOAT vDistance;
...
//		壁からの位置を計算する
//============================================================================
void StaticMeshObject::CalculatePositionFromWall(CROSSRAY* pCrossRay)
{
...
//		※頂点座標はローカル座標
//----------------------------------------------------------------------------
HRESULT StaticMeshObject::FindVerticesOnPoly(
	LPD3DXMESH pMesh,
	DWORD dwPolyIndex,
...
//		回転値調整（１周以上している時の調整）
//----------------------------------------------------------------------------
void StaticMeshObject::ClampDirection(float* dir)
{
