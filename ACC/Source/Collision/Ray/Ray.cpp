...
//		レンダリング用
//============================================================================
void Ray::Render( D3DXMATRIX& mView, D3DXMATRIX& mProj, RAY Ray)
{
	// 外部のレイ構造体を反映
	...
	// プリミティブをレンダリング
	m_pContext11->Draw( 2, 0 );	//レイ（線分なので頂点2つ分）
}