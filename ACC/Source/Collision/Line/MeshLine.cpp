...
//		レンダリング用
//============================================================================
void MeshLine::Render(D3DXMATRIX& mView, D3DXMATRIX& mProj)
{
	// ワールド行列
	D3DXMATRIX	mWorld;
...
//		メッシュからワイヤーフレーム
//=============================================================================
void MeshLine::DrawMeshWireframeFromVertices(
	...
	const float&		scale)
{
	...
	DirectX11* directx11 = DirectX11::GetInstance();
