...
private:
	...
	// 選択されたUIをハイライトする
	void ImGuiSetShader(UIObject* object);
	// 座標調整関数(選択されたUIObect)
	void ImGuiPosEdit(UIObject* object);
	// Z座標を元にソートする関数(選択されたUIObect)
	void SortBySpritePosZ(UIObject* object);
	// 情報調整関数(選択されたUIObect)
	void ImGuiInfoEdit(UIObject* object);
	// パターンお試し関数(選択されたUIObect)
	void ImGuiPatternTest(UIObject* object);
	// その他の情報調整関数(選択されたUIObect)
	void ImGuiEtcInfoEdit(UIObject* object);
